...
var translateSubMod = angular.module('translate.sub',[]);
	 ...
	 * Example: {{"DIALOGS_CLOSE" | _translate}}
	 */
	translateSubMod.filter('_translate',['$translate',function($translate){
