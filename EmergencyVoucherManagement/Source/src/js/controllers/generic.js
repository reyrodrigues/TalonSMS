...
app.controller('GenericCreateCtrl', ['breeze', 'backendService', '$scope', '$state', '$q', 'settings',
...
app.controller('GenericEditCtrl', ['breeze', 'backendService', '$scope', '$state', '$q', '$http', 'dialogs', 'settings', 'serviceBase', 'toaster',
...
app.controller('GenericGridCtrl', ['breeze', 'backendService', '$scope', '$http', '$localStorage', '$state', 'settings',
