angular.module('app').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('tpl/blocks/header.html',
    "<!-- navbar header --><div class=\"navbar-header {{app.settings.navbarHeaderColor}}\"><button class=\"pull-right visible-xs dk\" ui-toggle-class=\"show\" data-target=\".navbar-collapse\"><i class=\"glyphicon glyphicon-cog\"></i></button> <button class=\"pull-right visible-xs\" ui-toggle-class=\"off-screen\" data-target=\".app-aside\" ui-scroll-to=\"app\"><i class=\"glyphicon glyphicon-align-justify\"></i></button><!-- brand --> <a href=\"\" ui-sref=\"app.dashboard\" class=\"navbar-brand text-lt\"><i class=\"fa fa-ticket\"></i> <span class=\"hidden-folded m-l-xs\">{{app.name}}</span></a><!-- / brand --></div><!-- / navbar header --><!-- navbar collapse --><div class=\"collapse pos-rlt navbar-collapse box-shadow {{app.settings.navbarCollapseColor}}\"><!-- buttons --><div class=\"nav navbar-nav hidden-xs\"><a href class=\"btn no-shadow navbar-btn\" ng-click=\"app.settings.asideFolded = !app.settings.asideFolded\"><i class=\"fa {{app.settings.asideFolded ? 'fa-indent' : 'fa-dedent'}} fa-fw\"></i></a></div><!-- / buttons --><!-- search form --><!-- / search form --><!-- nabar right --><ul class=\"nav navbar-nav navbar-right\"><li class=\"dropdown hidden-sm\" is-open=\"lang.isopen\" dropdown><a href class=\"dropdown-toggle\" dropdown-toggle>{{selectLang}} <b class=\"caret\"></b></a><!-- dropdown --><ul class=\"dropdown-menu animated fadeInRight w\"><li ng-repeat=\"(langKey, label) in langs\"><a ng-click=\"setLang(langKey, $event)\" href>{{label}}</a></li></ul><!-- / dropdown --></li><li class=\"dropdown\" dropdown><a href class=\"dropdown-toggle clear\" dropdown-toggle><span class=\"hidden-sm hidden-md\">{{ me.Email }}</span> <b class=\"caret\"></b></a><!-- dropdown --><ul class=\"dropdown-menu animated fadeInRight w\"><li><a ui-sref=\"app.page.profile\" translate=\"header.navbar.settings.PROFILE\">Profile</a></li><li><a ui-sref=\"app.docs\" translate=\"header.navbar.settings.HELP\">Help</a></li><li class=\"divider\"></li><li><a href=\"\" ng-click=\"logOut()\" translate=\"header.navbar.settings.LOGOUT\">Logout</a></li></ul><!-- / dropdown --></li></ul><!-- / navbar right --></div><!-- / navbar collapse -->"
  );


  $templateCache.put('tpl/blocks/nav.html',
    "<!-- list --><ul class=\"nav ng-scope\"><li class=\"hidden-folded padder m-t m-b-sm text-muted text-xs\"><span class=\"ng-scope\">Voucher Management</span></li><li ui-sref-active=\"active\"><a href=\"\" ui-sref=\"app.dashboard\" class=\"auto\"><i class=\"glyphicon glyphicon-stats icon text-primary-dker\"></i> <span class=\"font-bold ng-scope\">Dashboard</span></a></li><li ng-class=\"{active:$state.includes('vendors')}\"><a href=\"\" class=\"auto\"><span class=\"pull-right text-muted\"><i class=\"fa fa-fw fa-angle-right text\"></i> <i class=\"fa fa-fw fa-angle-down text-active\"></i></span> <i class=\"fa fa-building-o text-success-lter\"></i> <span>Vendors</span></a><ul class=\"nav nav-sub dk\"><li class=\"nav-sub-header\"><a href=\"\"><span>Vendors</span></a></li><li ui-sref-active=\"active\"><a ui-sref=\"vendors.list\" href=\"#\"><span>List</span></a></li><li ui-sref-active=\"active\"><a ui-sref=\"vendors.create\" href=\"#\"><span>Register</span></a></li><!--\r" +
    "\n" +
    "        <li ui-sref-active=\"active\">\r" +
    "\n" +
    "            <a ui-sref=\"vendors.bulkUpdate\" href=\"#\">\r" +
    "\n" +
    "                <span>Bulk Update</span>\r" +
    "\n" +
    "            </a>\r" +
    "\n" +
    "        </li>\r" +
    "\n" +
    "             --></ul></li><li ng-class=\"{active:$state.includes('beneficiaries')}\"><a href=\"\" class=\"auto\"><span class=\"pull-right text-muted\"><i class=\"fa fa-fw fa-angle-right text\"></i> <i class=\"fa fa-fw fa-angle-down text-active\"></i></span> <i class=\"icon-user icon text-success-lter\"></i> <span>Beneficiaries</span></a><ul class=\"nav nav-sub dk\"><li class=\"nav-sub-header\"><a href=\"\"><span>Beneficiaries</span></a></li><li ui-sref-active=\"active\"><a ui-sref=\"beneficiaries.list\" href=\"#\"><span>List</span></a></li><li ui-sref-active=\"active\"><a ui-sref=\"beneficiaries.create\" href=\"#\"><span>Register</span></a></li><li ui-sref-active=\"active\"><a ui-sref=\"beneficiaries.bulkEdit\" href=\"#\"><span>Assign Group</span></a></li></ul></li><li ng-class=\"{active:$state.includes('groups')}\"><a href=\"\" class=\"auto\"><span class=\"pull-right text-muted\"><i class=\"fa fa-fw fa-angle-right text\"></i> <i class=\"fa fa-fw fa-angle-down text-active\"></i></span> <i class=\"icon-users icon text-success-lter\"></i> <span>Ben. Groups</span></a><ul class=\"nav nav-sub dk\"><li class=\"nav-sub-header\"><a href=\"\"><span>Beneficiary Groups</span></a></li><li ui-sref-active=\"active\"><a ui-sref=\"groups.list\" href=\"#\"><span>List</span></a></li><li ui-sref-active=\"active\"><a ui-sref=\"groups.create\" href=\"#\"><span>Create</span></a></li></ul></li><li ng-class=\"{active:$state.includes('distributions')}\"><a href=\"\" class=\"auto\"><span class=\"pull-right text-muted\"><i class=\"fa fa-fw fa-angle-right text\"></i> <i class=\"fa fa-fw fa-angle-down text-active\"></i></span> <i class=\"fa fa-truck text-primary-lter\"></i> <span>Distributions</span></a><ul class=\"nav nav-sub dk\"><li class=\"nav-sub-header\"><a href=\"\"><span>Distributions</span></a></li><li ui-sref-active=\"active\"><a ui-sref=\"distributions.list\" href=\"#\"><span>List</span></a></li><li ui-sref-active=\"active\"><a ui-sref=\"distributions.create\" href=\"#\"><span>Create</span></a></li><!--\r" +
    "\n" +
    "\r" +
    "\n" +
    "            <li ui-sref-active=\"active\">\r" +
    "\n" +
    "                <a ui-sref=\"distributions.bulkUpdate\" href=\"#\">\r" +
    "\n" +
    "                    <span>Bulk Update</span>\r" +
    "\n" +
    "                </a>\r" +
    ...
    "\r" +
    "\n" +
    "    <li ng-class=\"{active:$state.includes('vouchers')}\">\r" +
    "\n" +
    "        <a href=\"\" class=\"auto\">\r" +
    "\n" +
    "            <span class=\"pull-right text-muted\">\r" +
    "\n" +
    "                <i class=\"fa fa-fw fa-angle-right text\"></i>\r" +
    "\n" +
    "                <i class=\"fa fa-fw fa-angle-down text-active\"></i>\r" +
    "\n" +
    "            </span>\r" +
    "\n" +
    "            <i class=\"icon-wallet icon text-success-lter\"></i>\r" +
    "\n" +
    "            <span>Vouchers</span>\r" +
    "\n" +
    "        </a>\r" +
    "\n" +
    "        <ul class=\"nav nav-sub dk\">\r" +
    "\n" +
    "            <li class=\"nav-sub-header\">\r" +
    "\n" +
    "                <a href=\"\">\r" +
    "\n" +
    "                    <span>Vouchers</span>\r" +
    ...
    "            <li ui-sref-active=\"active\">\r" +
    "\n" +
    "                <a ui-sref=\"vouchers.list\" href=\"#\">\r" +
    "\n" +
    "                    <span>List</span>\r" +
    "\n" +
    "                </a>\r" +
    ...
    "            <li ui-sref-active=\"active\">\r" +
    "\n" +
    "                <a ui-sref=\"vouchers.assign\" href=\"#\">\r" +
    "\n" +
    "                    <span>Assign</span>\r" +
    "\n" +
    "                </a>\r" +
    ...
    "    </li>\r" +
    "\n" +
    "            --><li class=\"hidden-folded padder m-t m-b-sm text-muted text-xs\"><span class=\"ng-scope\">Reporting</span></li><li ng-class=\"{active:$state.includes('reporting')}\"><a href=\"\" class=\"auto\"><span class=\"pull-right text-muted\"><i class=\"fa fa-fw fa-angle-right text\"></i> <i class=\"fa fa-fw fa-angle-down text-active\"></i></span> <i class=\"icon-bar-chart icon text-success-lter\"></i> <span>Reporting</span></a><ul class=\"nav nav-sub dk\"><li class=\"nav-sub-header\"><a href=\"\"><span>Reports</span></a></li><li ui-sref-active=\"active\"><a ui-sref=\"reporting.activeVouchers\" href=\"#\"><span>Active Vouchers</span></a></li><li ui-sref-active=\"active\"><a ui-sref=\"reporting.vendoreReceipt\" href=\"#\"><span>Vendor Receipt</span></a></li></ul></li><li class=\"hidden-folded padder m-t m-b-sm text-muted text-xs\"><span class=\"ng-scope\">Administration</span></li><li ng-class=\"{active:$state.includes('admin.locations')}\"><a href=\"\" class=\"auto\"><span class=\"pull-right text-muted\"><i class=\"fa fa-fw fa-angle-right text\"></i> <i class=\"fa fa-fw fa-angle-down text-active\"></i></span> <i class=\"icon icon-pin text-info-lter\"></i> <span>Locations</span></a><ul class=\"nav nav-sub dk\"><li class=\"nav-sub-header\"><a href=\"\"><span>Locations</span></a></li><li ui-sref-active=\"active\"><a ui-sref=\"admin.locations.list\" href=\"#\"><span>List</span></a></li><li ui-sref-active=\"active\"><a ui-sref=\"admin.locations.create\" href=\"#\"><span>Create</span></a></li></ul></li><li ng-class=\"{active:$state.includes('admin.voucherTypes')}\"><a href=\"\" class=\"auto\"><span class=\"pull-right text-muted\"><i class=\"fa fa-fw fa-angle-right text\"></i> <i class=\"fa fa-fw fa-angle-down text-active\"></i></span> <i class=\"fa fa-tags text-success-lter\"></i> <span>Voucher Types</span></a><ul class=\"nav nav-sub dk\"><li class=\"nav-sub-header\"><a href=\"\"><span>Voucher Types</span></a></li><li ui-sref-active=\"active\"><a ui-sref=\"admin.voucherTypes.list\" href=\"#\"><span>List</span></a></li><li ui-sref-active=\"active\"><a ui-sref=\"admin.voucherTypes.create\" href=\"#\"><span>Create</span></a></li></ul></li></ul>"
  );
